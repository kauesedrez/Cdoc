            ...
            if (dir == null)
            {
                ...
                if (!pular)
                {
                    ...
                    if (arq.Extension == ".jpg" || arq.Extension == ".gif" || arq.Extension == ".png")
                    {
                        ...
                        fileTree_meio += spacos + "<img src = 'images/filetree.gif'> " + arq.Name + " <a href = 'javascript:void(0);' data-toggle = 'modal' data-target = '#" + contadorDeModals + "'><span class='glyphicon glyphicon-eye-open' aria-hidden='true' alt='Visualização Simples' title='Visualização Simples'></span></a><br>";
